...
class EasingFuncsSpec: QuickSpec {
    override func spec(){
        ...
        describe("QuadInOut easing: all keytimes between 0 and 1"){
            itBehavesLike("all keytimes between 0 and 1"){
                ["easing":QuadInOutEasing()]
            }
        }
        describe("CubicInOut easing: all keytimes between 0 and 1"){
            itBehavesLike("all keytimes between 0 and 1"){
                ["easing":CubicInOutEasing()]
            }
        }
        describe("QuartInOut easing: all keytimes between 0 and 1"){
            itBehavesLike("all keytimes between 0 and 1"){
                ["easing":QuartInOutEasing()]
            }
        }
